...
ActiveRecord::Schema.define(:version => 20130329022724) do
  ...
  add_index "episodes", ["tv_id"], :name => "index_episodes_on_tv_id"
  ...
  add_index "taggings", ["tv_id"], :name => "index_taggings_on_tv_id"
